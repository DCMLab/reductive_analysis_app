...
class Bookmarks {
  ...
  get currentContextItems() {
    ...
    return this.items.filter((bookmark) => parseInt(bookmark.dataset.contextId) == contextId);
  }
  ...
  goTo(dir = 1) {
    ...
    if (dir > 0) {
      targetBookmark = this.currentContextItems.find((bookmark) => {
        ...
        return (
          rect.right > viewport.w || // out of the viewport right side
    ...
    if (dir < 0) {
      ...
      targetBookmark = this.currentContextItems.find((bookmark) => {
        ...
        return (
          rect.left < 0 || // out of the viewport left side
          // or at the right of the viewport middle
