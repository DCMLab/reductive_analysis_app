...
export default class Reductions {
  ...
  onTap(e) {
    ...
    if (e.target == this.reduceBtn) {
      return this.reduce(currentLayerObject);
    }
    if (e.target == this.unreduceBtn) {
      return this.unreduce(currentLayerObject);
    }
    if (e.target == this.playReductionBtn) {
      return this.play(currentLayerObject);
    }
  }
}
